...
├── models.py              # Pydantic data models (Card, CryptCard, LibraryCard, Deck, Tournament, TdaDeck)
...
├── test_scraper_tda.py
└── test_validator.py
                               # TWD/TDA data and publish reports live in gurchon-hall/eternal-vigilance
.github/
└── workflows/
